...
<div id="signinContainer1">
    <form action="infomation/changeuser.php" method="get" onsubmit="return ktdk();"> 
		...
		<div style="width:95%; height:490px; margin-left:2.5%; margin-top:50px">
			...
			<p><i class="fas fa-lock fa-1.5x"></i> Tinh Trang <p>
                ...
                ?></p>
            <p>
                <i class="fas fa-shield-alt"></i> Quyền</p><p>
                <?php
                    if($quyen==2){
                        echo '<input type="radio" value="2" name="quyen" style="margin-left:3%" checked/> Khách hàng
                        <input type="radio" name="quyen" value="3" style="margin-left:3%"/> Nhân Viên
                        <input type="radio" name="quyen" value="1"/> Quản trị viên</p>';
                    }
                    if($quyen==1) {
                        echo '<input type="radio" value="2" name="quyen" style="margin-left:3%"/> Khách hàng
                        <input type="radio" name="quyen" value="3" style="margin-left:3%" /> Nhân Viên
					    <input type="radio" name="quyen" value="1" checked/> Quản trị viên</p>';
                    }
                    else {
                        echo '<input type="radio" value="2" name="quyen" style="margin-left:3%"/> Khách hàng
                        <input type="radio" name="quyen" value="3" style="margin-left:3%" checked/> Nhân Viên
					    <input type="radio" name="quyen" value="1" /> Quản trị viên</p>';
                    }
                ?>
