...
<div id="signinContainer1">
    <form action="product/ttnewpro.php" method="post" onsubmit="return ktrapro();" enctype="multipart/form-data">
        ...
        <div style="width:95%; height:430px; margin-left:2.5%; margin-top:50px">
            ...
            <p><b>Dung tích</b></p>
            <p><input type="text" name="con" id="con" placeholder="Nhập dung tích sản phẩm..."></p>
